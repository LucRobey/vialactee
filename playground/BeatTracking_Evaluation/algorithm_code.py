...
def run_simulation_with_beats(audio_features):
    ...
    for frame_idx, onset_val in enumerate(audio_features['odf']): 
        ...
        if frame_idx < 300:
            ...
            best_class, _ = class_based_phase_sweep(buffer_centered, buffer_std, class_evals)
            ...
            bpm_pearson_raw, score_pearson = evaluate_specific_bpms(buffer_centered, buffer_std, candidates)
