# Agent Initialization Protocol for Research

When a user asks you to run this initialization protocol on a specific `[folder]`, you MUST perform the following steps to build your context before taking any action or writing any code.

## Step 1: Understand the Rules
Read `playground/README.md` to understand the rules and directory structure of this research environment.

## Step 2: Understand the Global Goal
Read `playground/RESEARCH_BOARD.md` to understand the overarching research objective and current project-wide progress.
