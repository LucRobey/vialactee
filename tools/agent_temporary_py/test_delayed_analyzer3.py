...
print("VAL Starting Lookahead Analysis (5s Buffer)...")
...
print(f"VAL Finished! Extracted {len(alg_beats_array)} Lookahead algorithmic beats and {len(alg_sub_beats_array)} sub-beats.")
...
print(f" RIGHT (Sub-Beats): {s_hits} perfectly synced.")
...
plt.xlim(time_slice)
plt.tight_layout()
plt.savefig("result_evaluation.png")
print("Saved performance plot to result_evaluation.png")
