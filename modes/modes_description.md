...
*   **Alcool_randomer**
    **Visual:** A bright white dot (acting as a "ball") spins rapidly back and forth across the entire LED strip. As it moves, it leaves a white trail behind it that gradually fades to black. The ball spins very fast at first, then slows down noticeably over a few phases, taking random small steps at the end before freezing on a final LED position. It visually mimics a roulette ball losing momentum and coming to a halt.
